...
<div class="standard_block">
    <form method="POST" action="<?=base_url('admin/student/do-edit/' . $stu->id)?>">
        ...
        <table class="table_standard table_left">
            ...
            <tr class="table_header">
                <td colspan="4">
                    <input class="button_standard" type="submit" value="Submit" onclick="return confirm('Are you sure to edit?')"/>
