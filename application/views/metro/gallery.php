        ...
        <div id="upper_header">
            <div id="wrapper_inside">
                <div class="left_col">
                    ...
                    <a href="<?=base_url()?>">
                        <img id="logo" src="<?=base_url('asset/themes/_img/home1.png')?>" alt="Home"
                             title="<?=$this->config->item('system_full_name')?> - Home page"/>
                    </a>
                    <a href="mailto:huy.nguyenkim@vanphuc.sis.edu.vn">
                        <img src="<?=base_url('asset/themes/_img/email2.png')?>" alt="Support" title="Contact supporter"/>
                    </a>
                    ...
                    <a href="<?=base_url()?>" title="<?=$this->config->item('system_full_name')?>">
                        <img id="logo" src="<?=base_url('asset/themes/_img/favicon.ico')?>"
                ...
                <div class="align_right">
                    ...
                    <div>
                        <form method="POST" action="<?=base_url('home/do_login')?>">
                            ...
                            <img src="<?=base_url('asset/themes/_img/email2.png')?>" alt="Support"
...
<!--    <img src="--><?//=base_url('asset/themes/_img/iview')?><!--/bckg.jpg" style="width: 100%;height: 100%;"/>-->
</div>
