...
<html>
<head>
    <? $this->load->view('includes/head_tags'); ?>
    ...
    <div id="upper_header" style="height: 30px;">
        <div style="width: 100%;text-align: center;">
            <div class="container_16" style="color: orange;">
                <div class="left_col">
                    <a href="<?=base_url()?>">
                        <img src="<?=base_url('styles/img/home1.png')?>" alt="Home"
                             title="<?=$this->config->item('system_full_name')?> - Home page"/>
                    </a>
                    <a href="mailto:huy.nguyenkim@vanphuc.sis.edu.vn">
                        <img src="<?=base_url('styles/img/email2.png')?>" alt="Support" title="Ask for support"/>
                    </a>
...
<div id="background-image">
    <img src="<?=base_url('styles/img/iview')?>/bckg.jpg" width="1820" height="1024"/>
</div>
