...
<div class="align_center">
    ...
    <a title="Click to view Ranking board version 2" href="<?=base_url('attendance/report_daily_v2')?>">Rank v2</a>
</div>
<div id="rank_board" style="background: #044062;border: 1px solid;text-align: center" title="Ranking starts from 8:30 AM">
    <img id="btn_hide_rank" src="<?=base_url('styles/img/x.png')?>" style="float: right" title="Click to hide this panel"/>
    <img src="<?=base_url('styles/img/tip_info.png')?>" style="float: right" title="To keep it fair, only submissions taken from 8:30 AM & afterward are eligible for ranking. You can still submit before 8:30 AM but it won't be counted for ranking."/>
    ...
    <ul style="display: inline-block;">
        ...
        foreach ($best_staff as $item) {
            ...
            <li style="width: 90px;float: left;text-align: center;color: #b3c7e1;">
                ...
                <p>
                    <img src="<?=base_url('styles/img/medal' . $iCount . '.png')?>" width="30px" alt=""><br/>
