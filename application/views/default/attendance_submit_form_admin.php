...
<p style="text-align:center;">
	<a class="highlight_note" id="list_unsubmitted" href="#" title="Click here to see which classes haven't submitted">Which classes haven't submitted? Click here!</a>
</p>
        ...
        foreach ($all_classes_attendance as $item) {
            ...
            <tr class="table_body_row">
                ...
                <td>
                    <?
                    if ($item->has_absent == '') {
                        $outputHTML = '<a style="color:red;" title="Click to report this class as FULLY ATTENDED" href="' . base_url('attendance/do_submit_full/' . $item->id . '/' . $selected_date) . '"';
