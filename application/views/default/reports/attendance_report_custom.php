...
<div id="studentSearchForm" class="standard_block border_square">
    <div title="Chọn khoảng thời gian muốn report!">
        <form id='form_export' name="class_list" method="GET" action="<?=base_url(URL_ATTENDANCE_REPORT_CUSTOM_TIME)?>">
            <strong>Class:</strong>
            ...
            <strong>To:</strong> <input title="Đến ngày:" name="to" type="text" class="datepicker txtDatePicker"
                                        value="<?=$input_data['to']?>"/>
            <input id='generate_report' onclick=" return report_export();" class="button_standard" type="submit" value="Generate"/>
        </form>
    </div>
</div>
