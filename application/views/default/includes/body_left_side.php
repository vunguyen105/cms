    ...
    <div>
        <div class="left_menu_box border_standard">
            ...
            <ul>
				...
				<li><a href="<?=base_url(URL_ATTENDANCE_REPORT_STATS)?>">Attendance stats</a></li>
                <li><a href="<?=base_url(URL_TEACHER_COMMENT)?>">Teacher's Comments</a></li>
            </ul>
        </div>
        <div class="left_menu_box border_standard">
            ...
            <ul>
                ...
                <li>
                    <a title="Access school email via web" href="http://mail.office365.com" target="_blank">
                        School Email
                    </a>
                </li>
                <li>
