...
<ul data-role="listview" data-icon-pos="right">
    ...
    <li>
        ...
        if ($item->has_absent == '') {
            ?>
            <img src="<?=base_url('styles/img/x.png')?>" alt=".." class="ui-li-icon">
            <?
        } else if ($item->has_absent == 0) {
            ?>
            <img src="<?=base_url('styles/img/accept-24.png')?>" alt="Full" class="ui-li-icon">

            <?
        } else if ($item->has_absent == 1) {
            ?>
            <img src="<?=base_url('styles/img/checked-red.png')?>" alt="Absent" class="ui-li-icon">
            <? }?>
    </li>
