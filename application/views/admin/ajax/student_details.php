    ...
    <table class="table_standard table_left">
        ...
        <tr>
            ...
            <td>
                ...
                <?if ($stu->modified_by) { ?>by <strong><a class="staff_info_modal"
                                                           href="<?=base_url('staff/' . $stu->modified_by)?>">Staff <?=$stu->modified_by?></a></strong><? }?>
            </td>
        </tr>
        <tr class="table_header">
            <td colspan="4">
                ...
                <a onclick="return confirm('Are you sure to withdraw this student?')" class="button_standard"
