...
<div class="standard_block">
    <form id="form_add" method="POST" action="<?=base_url('admin/student/do-add')?>" enctype="multipart/form-data">
        <table class="table_standard table_left">
            ...
            <tr>
                ...
                <td>Photo:<input type="file" name="photo" id="photo" size="20"/> (max 500KB)</td>
            </tr>
            <tr>
                <td>Gender:</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input name="nationality" type="text" value="Vietnamese"/>
                </td>
                <td></td>
            </tr>
            <tr>
