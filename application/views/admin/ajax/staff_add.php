...
<!--                        <option value="">--All--</option>-->
            ...
            <tr>
                ...
                <td><input type="file" name="photo" id="photo" size="20" title="Max 500KB"/> (max 500KB)</td>
            </tr>
            <tr>
                <td>Nationality:</td>
                <td>
            ...
            <tr>
                <td>Joined on:</td>
                <td>
                    <input class="txtDatePicker" type="text" value="<?=date('Y-m-d')?>" name="joined_on"/>
                </td>
            </tr>
            <tr>
                <td>Status:</td>
